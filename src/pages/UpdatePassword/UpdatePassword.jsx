...
export default function UpdatePassword() {
  ...
  let validYup = Yup.object({
    ...
    newPassword: Yup.string()
      .required("New Password Is Requird")
      .matches(
    ...
    <>
      ...
      <form onSubmit={newPasswordForm.handleSubmit} className="w-7/12 mx-auto ">
        <div className="mb-5">
          ...
          <input
            value={newPasswordForm.values.email}
          ...
          />
          {newPasswordForm.touched.email && newPasswordForm.errors.email ? (
            <p className="text-red-700">{newPasswordForm.errors.email}</p>
          ) : (
            ""
          )}
        </div>
        <div className="mb-5">
          ...
          newPasswordForm.errors.password ? (
            <p className="text-red-700">{newPasswordForm.errors.password}</p>
          ) : (
            ""
          )}
        </div>
        ...
        <button
          type="submit"
          disabled={!(newPasswordForm.isValid && newPasswordForm.dirty)}
